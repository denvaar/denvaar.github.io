...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function toggleFilter(value, filterCategory) {
      ...
      this.setState(_extends({ offset: '' }, newState), function () {
    ...
    value: function changeView(key, newValue) {
      ...
      this.setState((_setState = {}, _defineProperty(_setState, key, newValue), _defineProperty(_setState, 'offset', ''), _defineProperty(_setState, 'selectedFilters', []), _setState), function () {
    ...
    value: function makeRequest() {
      ...
      var url = airtableBase + '/' + this.state.selectedCategory + '?pageSize=10&offset=' + (this.state.offset || '');
      ...
      _axios2.default.get(url, { headers: { Authorization: "Bearer keyHXT2ee1ZGTfuyq" } }).then(function (response) {
        if (appendResults) {
          _this5.setState({
            ...
            records: [].concat(_toConsumableArray(_this5.state.records), _toConsumableArray(mapRecords(response.data.records)))
          });
        } else {
          _this5.setState({
            isLoading: false,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_RecordsContainer2.default, {
            records: this.state.records,
            isLoading: this.state.isLoading,
            requestMoreRecords: function requestMoreRecords() {
              if (!_this6.state.offset) return;_this6.setState({ isLoading: true });_this6.makeRequest(true);
            }
          })
        )
      );
...
var _reactMasonryComponent = __webpack_require__(8);
...
var InfinateScrollContainer = function (_React$Component) {
  _inherits(InfinateScrollContainer, _React$Component);

  function InfinateScrollContainer() {
    _classCallCheck(this, InfinateScrollContainer);

    return _possibleConstructorReturn(this, (InfinateScrollContainer.__proto__ || Object.getPrototypeOf(InfinateScrollContainer)).apply(this, arguments));
  }

  _createClass(InfinateScrollContainer, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
  ...
  return InfinateScrollContainer;
...
var RecordsContainer = function RecordsContainer(_ref) {
  var records = _ref.records,
      ...
      requestMoreRecords = _ref.requestMoreRecords;
  return _react2.default.createElement(
    'div',
    { className: 'wrapper' },
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        {
          isLoading: isLoading,
          maxScrollEvent: function maxScrollEvent() {
        ...
        records.map(function (record) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement('img', { src: record.thumbUrl }),
            _react2.default.createElement(
              'div',
              null,
              record.title
...
//# sourceMappingURL=app.static.a7218ca1.js.map